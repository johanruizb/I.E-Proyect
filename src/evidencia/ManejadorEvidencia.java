...
//     
        ...
        this.estado = estado;
        this.iden = new JLabel(id,SwingConstants.RIGHT);
        this.reference = new JLabel(referencia,SwingConstants.RIGHT);
        this.fechaEvidencia = new JLabel(fecha,SwingConstants.RIGHT);
        ...
        if (estado.equals("EN-ESPERA")) {
            ...
            this.icono = new JLabel(new ImageIcon("src/imagenes2/rechazada.png"));
        } else {
